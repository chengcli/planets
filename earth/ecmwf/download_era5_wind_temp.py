#!/usr/bin/env python3
"""
Convenient script to download temperature, u-wind, and v-wind from ERA5.
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description='Download ERA5 temperature and wind data at all pressure levels.',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Download data for White Sands, New Mexico
  python download_era5_wind_temp.py --latmin 32.0 --latmax 33.5 \\
                                     --lonmin -106.8 --lonmax -105.8 \\
                                     --start-date 2024-01-01 \\
                                     --end-date 2024-01-02 \\
                                     --output white_sands_wind_temp.nc
...
def main():
    ...
    print("=" * 70)
    print("ERA5 Wind and Temperature Data Download")
    print("=" * 70)
    print(f"\nRegion:")
    ...
    print(f"\nVariables:")
    print(f"  - Temperature")
    print(f"  - U-component of wind")
    print(f"  - V-component of wind")
