#!/usr/bin/env python3
"""
Ann Arbor Weather Data Download Script (Compatibility Wrapper)

This is a backward-compatibility wrapper that calls the unified
download_location_data.py script with the ann-arbor location.

For new workflows, please use the unified script directly:
    python ../download_location_data.py ann-arbor [options]
...
def main():
    ...
    command = ["python3", str(unified_script), "ann-arbor"]
    ...
    if "--config" not in sys.argv:
        config_path = script_dir / "ann_arbor.yaml"
