...
if __name__ == "__main__":
    ...
    out2 = NetcdfOutput(OutputOptions().file_basename("uranus").fid(2).variable("prim"))
    out3 = NetcdfOutput(OutputOptions().file_basename("uranus").fid(3).variable("uov"))
    out4 = NetcdfOutput(OutputOptions().file_basename("uranus").fid(4).variable("diag"))
